window.addEventListener('load', event => {
    ...
    let messagesInput = document.getElementById('messages-output')
    messagesInput.innerHTML = ''

    fetch("http://localhost:8080/messages-output-list", requestOptions)
    ...
    .then(json => json.forEach(m => {
        ...
        linkToMess1.textContent = m.receiver.username
